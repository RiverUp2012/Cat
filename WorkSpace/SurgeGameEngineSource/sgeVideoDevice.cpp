...
typedef IDirect3D9 * (WINAPI * sgeDirect3DCreate9)(
	UINT SDKVersion);

sgeVideoDevice::sgeVideoDevice()
{
	mD3DDev9 = 0;
}
...
bool sgeVideoDevice::create(
	sgeWindow & window,
	const int screenWidth,
	const int screenHeight)
{
	bool ret = false;
	sgeDirect3DCreate9 direct3DCreate9 = 0;
	IDirect3D9 * d3d9 = 0;
	D3DPRESENT_PARAMETERS d3dpp = { 0 };

	if (!mD3DDev9)
	{
		direct3DCreate9 = (sgeDirect3DCreate9)gModuleD3D9.getProcAddressA("Direct3DCreate9");
		if (direct3DCreate9)
		{
...
void sgeVideoDevice::destroy(void)
{
	if (mD3DDev9)
	{
		mD3DDev9->Release();
...
bool sgeVideoDevice::isAlready(void) const
{
	return mD3DDev9 ? true : false;
}

IDirect3DDevice9 * sgeVideoDevice::getIDirect3DDevice9(void) const
{
	return mD3DDev9;
}

bool sgeVideoDevice::clear(const unsigned int clearColor)
{
	if (mD3DDev9)
	{
...
bool sgeVideoDevice::present(void)
{
	if (mD3DDev9)
	{
		gBatchSprite.flush();
...
void sgeVideoDevice::setupDefaultRenderStatus(void)
{
	if (mD3DDev9)
	{
