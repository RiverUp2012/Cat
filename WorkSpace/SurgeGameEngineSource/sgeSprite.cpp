...
sgeSprite::sgeSprite(sgeTexture * texture)
{
...
bool sgeSprite::createFromTexture(sgeTexture * texture)
{
...
bool sgeSprite::paint(void)
{
	sgeSpriteVertex vertexList[4] = { 0 };
